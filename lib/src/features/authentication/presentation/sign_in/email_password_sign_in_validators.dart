...
mixin EmailAndPasswordValidators {
  ...
  String? emailErrorText(String email, BuildContext context) {
    ...
    final String errorText =
        email.isEmpty ? context.loc.emptyEmailErrorText : context.loc.invalidEmailErrorText;
  ...
  String? passwordErrorText(String password, BuildContext context) {
    ...
    final String errorText =
        password.isEmpty ? context.loc.emptyPasswordErrorText : context.loc.shortPasswordErrorText(AppConstants.minPasswordLength);
    return showErrorText ? errorText : null;
  }
}
