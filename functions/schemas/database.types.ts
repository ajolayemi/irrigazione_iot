  ...
  public: {
    ...
    Functions: {
      ...
      check_if_user_is_privileged: {
        Args: { user_email: string; current_company_id: number }
        Returns: boolean
      }
      ...
      get_board_company_id: {
        Args: { board_id_input: number }
        Returns: number
      }
      get_collector_company_id: {
        Args: { collector_id_input: number }
        Returns: number
      }
      get_collectors_not_connected_to_a_board: {
        Args: { company_id_input: number; id_already_connected?: number }
        Returns: {
          company_id: number
          created_at: string
          has_filter: boolean
      ...
      get_weather_station_company_id: {
        Args: { sensor_id_input: number }
        Returns: number
      }
      latest_collector_pressure_data: {
        Args: Record<PropertyKey, never>
        Returns: {
          collector_id: number
          created_at: string
      ...
      latest_pump_status_data: {
        Args: Record<PropertyKey, never> | { company_id_input: number }
        Returns: {
          company_id: number
          created_at: string
          id: number
      ...
      seconds_since_pump_last_switched_on: {
        Args: { pump_id_input: number; current_status_timestamp: string }
        Returns: number
      }
    }
    Enums: {
