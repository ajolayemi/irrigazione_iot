...
class CompanyUserListTileItem extends ConsumerWidget {
  const CompanyUserListTileItem({super.key, required this.companyUser, required this.isMe});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isDeleting = ref.watch(dismissCompanyUserControllerProvider).isLoading;
      ...
      child: IgnorePointer(
        ...
        child: InkWell(
          ...
          child: ListTile(
            ...
            subtitle: Text(companyUser.email, style: context.commonSubtitleStyle),
