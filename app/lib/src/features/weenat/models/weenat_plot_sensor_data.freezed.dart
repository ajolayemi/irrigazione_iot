...
mixin _$WeenatPlotSensorData {
  ...
  $WeenatPlotSensorDataCopyWith<WeenatPlotSensorData> get copyWith =>
      _$WeenatPlotSensorDataCopyWithImpl<WeenatPlotSensorData>(
          this as WeenatPlotSensorData, _$identity);
...
abstract mixin class $WeenatPlotSensorDataCopyWith<$Res> {
  factory $WeenatPlotSensorDataCopyWith(WeenatPlotSensorData value,
          $Res Function(WeenatPlotSensorData) _then) =
      _$WeenatPlotSensorDataCopyWithImpl;
  @useResult
  $Res call(
      {int? id,
...
class _WeenatPlotSensorData extends WeenatPlotSensorData {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WeenatPlotSensorDataCopyWith<_WeenatPlotSensorData> get copyWith =>
      __$WeenatPlotSensorDataCopyWithImpl<_WeenatPlotSensorData>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$WeenatPlotSensorDataToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _WeenatPlotSensorData &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.sensorData, sensorData) ||
                other.sensorData == sensorData) &&
            (identical(other.sensorDataDepth, sensorDataDepth) ||
...
/// @nodoc
abstract mixin class _$WeenatPlotSensorDataCopyWith<$Res>
    implements $WeenatPlotSensorDataCopyWith<$Res> {
  factory _$WeenatPlotSensorDataCopyWith(_WeenatPlotSensorData value,
          $Res Function(_WeenatPlotSensorData) _then) =
      __$WeenatPlotSensorDataCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? id,
