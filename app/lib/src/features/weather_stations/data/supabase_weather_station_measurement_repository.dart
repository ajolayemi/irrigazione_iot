...
class SupabaseWeatherStationMeasurementRepository implements WeatherStationMeasurementRepository {
  const SupabaseWeatherStationMeasurementRepository(this._supabaseClient);
  final SupabaseClient _supabaseClient;

  @override
  Future<WeatherStationMeasurement?> getStationMeasurement(String weatherStationId) async {
    final data =
        await _supabaseClient.weatherStationMeasurements
            .select()
            .eq(WeatherStationMeasurementsDatabaseKeys.weatherStationId, weatherStationId)
            .order(WeatherStationMeasurementsDatabaseKeys.createdAt, ascending: false)
            .limit(1)
            .maybeSingle();
