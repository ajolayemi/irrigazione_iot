...
class PumpTileTitle extends ConsumerWidget {
  const PumpTileTitle({super.key, required this.pump, this.style});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Row(
      ...
      children: [Flexible(child: Text(pump.name, style: style)), gapW8, CommonStatusIndicator(status: isSwitchedOn)],
    );
  }
}
