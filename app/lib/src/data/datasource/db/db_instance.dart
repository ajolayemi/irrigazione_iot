  ...
  Future<void> initLocalDb() async {
    ...
    final isar = await Isar.open(
      [
        ...
        LocalPumpStatusSchema,
        LocalPumpSwitchedOnSchema,
        LocalSectorStatusSchema,
        LocalSectorSwitchedOnSchema,
        LocalPumpFlowSchema,
        LocalPumpPressureSchema,
        LocalCollectorPressureSchema,
        LocalTerminalPressureSchema,
        LocalSectorPressureSchema,
      ],
      directory: dir.path,
    );
    _isar = isar;
