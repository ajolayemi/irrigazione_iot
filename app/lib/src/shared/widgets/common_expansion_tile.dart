...
class CommonExpansionTile extends StatelessWidget {
  const CommonExpansionTile({super.key, required this.title, required this.children});
  ...
  Widget build(BuildContext context) {
    return ExpansionTile(title: Text(title, style: context.textTheme.titleLarge), children: children);
  }
}
