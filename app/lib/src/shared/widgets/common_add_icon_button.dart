...
class CommonAddIconButton extends ConsumerWidget {
  const CommonAddIconButton({super.key, required this.onPressed, this.alternateIsVisible});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AppBarIconButton(onPressed: onPressed, icon: Icons.add, isVisibile: alternateIsVisible ?? canEdit);
  }
}
